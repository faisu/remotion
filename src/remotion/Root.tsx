    ...
    <>
      ...
      <Composition
        ...
        calculateMetadata={async ({ props }) => {
          const parsed = DynamicVideoProps.parse(props);
          const durationInSeconds = getDynamicDurationInSeconds(parsed);
          const { width, height } = resolveAspectRatio(parsed.aspectRatio);
          return {
